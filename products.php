...
<div class="m-5">
      ...
      <div class="col-12 m-2 text-weight-bold">
      <b> Category Filter</b>
      </div>
      <div class="col">
      <select name="productcategory" id="" class=" browser-default custom-select">
                        ...
                        ?>
                                ...
                                <!-- <div class="col"> -->
        <input type="text" class="form-control ml-auto" placeholder=" Search " style="width:300px;">
...
<div class="card card-cascade narrower card-ecommerce">
  ...
  <div class="view view-cascade zoom overlay">
    <img src="<?php  echo $Product['imageLocation'];  ?>" class="img-fluid p-3 justify-" alt="" style="height:250px; width:100%;">
    <a>
  ...
  <div class="card-body card-body-cascade text-center no-padding">
    ...
    <div class="card-footer">
      <span class="float-left">
       <?php echo $Product['discountPrice']; ?>₹
       <del class="text-danger"><?php echo $Product['price']; ?>₹</del>
      </span>
      <span class="float-right">
       
        <!-- Button trigger modal -->
<a class="btn  blue-gradient text-white m-0" href="productpage.php?AfjkshfrjkoewrsfghekghreoiyoERoiwrtucwaercrthKJTPYKYPJKIEOE394304e12cwwfgcwro12344982509lkcfopfgrejkgpom4908kc33j9m04t98j3t9873juerFkcog=<?php echo $Product['sku'];  ?>"  data-toggle="tooltip" data-placement="top" title="Quick View" >
