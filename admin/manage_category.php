...
<div class="d-flex align-items-center py-3 unique-color">
        <div class="container  text-center ">
          <h3 class="text-white">Manage Category</h3>
        </div>
</div>
<div class="cntainer">
<button data-toggle="modal" data-target="#AddCategory" class="btn btn-primary float-right m-3">Add Category</button> <br>
        ...
        <div class="modal-content">
            <form id="addCategory">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" id="SaveCategory" name="SaveCategory" value="O9onhRErX1dVPnndgkkxMLUF1Q">Save Category</button>
  ...
  <?php
                ...
                ?>
                    <tr>
                        ...
                        <td> <?php echo " <button data-toggle='modal' data-target='#EditCategory" . $row['categoryId'] . "'  data-id='" . $row['categoryId'] . "' class='btn btn-warning'> Edit </button>"; ?> </td>
                        <td> <?php echo " <button data-toggle='modal' data-target='#DeleteCategory" . $row['categoryId'] . "'  data-id='" . $row['categoryId'] . "' class='btn btn-danger'> Delete </button>"; ?> </td>

                    </tr>
                    <div class="modal fade" id="EditCategory<?php echo $row['categoryId']; ?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form class="editCategory" data-id='<?php echo $row['categoryId']; ?>'>
                                    <!-- Modal Header -->
                                    <span class="alertMsg"></span>
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Category</label>
                                            <input type="text" class="form-control" id="Category<?php echo $row['categoryId']; ?>" aria-describedby="emailHelp" placeholder="Enter Category" name="category" value="<?php echo $row['name'];  ?>">
                                            <span id='emailMsg'></span>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Modal footer -->
                                    <div class="modal-footer">
                                        <button type="submit" data-id='<?php echo $row['categoryId']; ?>' class="btn btn-success" id="SaveCategory<?php echo $row['categoryId']; ?>" name="SaveCategory" value="O9onhRErX1dVPnndgkkxMLUF1Q">Save Category</button>
                                        <button type="button" data-dismiss="modal" class="btn btn-danger" id="CancleCategory" name="CancleCategory" value="O9onhRErX1dVPnndgkkxMLUF1Q">Cancle Category</button>
                                    </div>
                                </form>
                    ...
                    <div class="modal fade" id="DeleteCategory<?php echo $row['categoryId']; ?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form class="deleteCategory" data-id='<?php echo $row['categoryId']; ?>'>
                                    <!-- Modal Header -->
                                    <span class="alertMsg"></span>
                                    <div class="modal-header">
                                    ...
                                    <!-- Modal footer -->
                                    <div class="modal-footer">
                                        <button type="submit" data-id='<?php echo $row['categoryId']; ?>' class="btn btn-danger" id="DeleteCategory<?php echo $row['categoryId']; ?>" name="SaveCategory" value="O9onhRErX1dVPnndgkkxMLUF1Q">Delete Category</button>
                                        <button type="button" data-dismiss="modal" class="btn btn-danger" id="CancleCategory" name="CancleCategory" value="O9onhRErX1dVPnndgkkxMLUF1Q">Cancle Category</button>
                                    </div>
                                </form>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(document).on('submit', '#addCategory', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'validatecategory.php',
                    data: {
                        category: email,
                        sbmit: $("#SaveCategory").val(),
                        action: "ADD"
                    },
                    beforeSend: function() {
                        // setting a timeout
