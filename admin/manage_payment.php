...
<div class="d-flex align-items-center py-3 unique-color">
    <div class="container  text-center ">
        <h3 class="text-white">Manage Payment</h3>
    </div>
</div>
            ...
            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        ...
                        <table id="dt-filter-select" class="table table-bordered " cellspacing="0" width="100%">
                            <thead class="black white-text">
                                <tr>
                                    ...
                                    <th class="th-sm">paymentDate</th>
                                    <th class="th-sm">PaymentMethodId</th>
                                    <th class="th-sm">PaymentStatusId</th>
                            </thead>
                            <tbody>

                                <?php
                $res = mysqli_query($link, "select * from payment");
                $srNo = 1;
                ...
                ?>
                                <tr>
                                    ...
                                    <td> <?php echo $row['paymentStatusId']; ?></td>
